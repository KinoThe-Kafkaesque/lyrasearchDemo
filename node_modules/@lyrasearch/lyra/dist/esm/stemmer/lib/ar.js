...
function stem() {
    ...
    function h() {
        ...
        switch (a) {
            case 1:
                if (!(3 < m.j.length) || !m.b("\u0623"))
                    return p;
                break;
            case 2:
                if (!(3 < m.j.length) || !m.b("\u0622"))
                    return p;
                break;
            case 3:
                if (!(3 < m.j.length) || !m.b("\u0627"))
                    return p;
                break;
            case 4:
                if (!(3 < m.j.length) || !m.b("\u0625"))
                    return p;
        }
        return g;
    }
    ...
    function d() {
        ...
        switch (a) {
            case 1:
                ...
                break;
            case 2:
                if (!(3 < m.j.length) || !m.b("\u0628"))
                    return p;
                break;
            case 3:
                if (!(3 < m.j.length) || !m.b("\u0643"))
                    return p;
        }
        return g;
    }
    function n() {
        ...
        switch (a) {
            case 1:
                if (!(4 < m.j.length) || !m.b("\u064a"))
                    return p;
                break;
            case 2:
                if (!(4 < m.j.length) || !m.b("\u062a"))
                    return p;
                break;
            case 3:
                if (!(4 < m.j.length) || !m.b("\u0646"))
                    return p;
                break;
            case 4:
                if (!(4 < m.j.length) || !m.b("\u0623"))
                    return p;
        }
        return g;
    }
    ...
    var m = new C(), w = [
        ...
        ["\u0648", -1, 1],
        ["\u064a", -1, 1],
    ], P = [["\u0627\u062a", -1, 1]], Q = [["\u062a", -1, 1]], T = [["\u0629", -1, 1]], U = [["\u064a", -1, 1]], R = [
        ["\u0643\u0645\u0627", -1, 3],
        ["\u0647\u0645\u0627", -1, 3],
        ["\u0646\u0627", -1, 2],
        ["\u0647\u0627", -1, 2],
