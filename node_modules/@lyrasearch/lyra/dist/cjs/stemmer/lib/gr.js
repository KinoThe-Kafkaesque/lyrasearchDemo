...
function stem() {
    ...
    function h() {
        ...
        if (0 != a.h(ca)) {
            ...
            a.d = a.cursor;
            a.c = a.cursor;
            if (0 != a.h(ba) && !(a.cursor > a.f) && !a.b("\u03b1\u03b3\u03b1\u03bd"))
                return;
        }
        a.cursor = a.a - b;
        a.d = a.cursor;
    ...
    var a = new C(), d = [
        ...
        ["\u03c5\u03c4\u03b1\u03c4", -1, 1],
        ["\u03c9\u03c4\u03b1\u03c4", -1, 1],
    ], ia = [81, 65, 16, 1], ha = [81, 65, 0, 1], B = p;
    this.l = function () {
        a.f = a.cursor;
        a.cursor = a.a;
        var d = a.a - a.cursor;
        ...
        a: {
            n = a.a - a.cursor;
            if (a.g("\u03b1\u03b3\u03b1\u03bc\u03b5") && !(a.cursor > a.f) && !a.b("\u03b1\u03b3\u03b1\u03bc"))
                break a;
            a.cursor = a.a - n;
            n = a.a - a.cursor;
            a.d = a.cursor;
        ...
        a: {
            ...
            if (a.g("\u03b9\u03b5\u03c3\u03c4\u03b5")) {
                ...
                a.d = a.cursor;
                a.c = a.cursor;
                if (0 != a.h(Y) && !(a.cursor > a.f) && !a.b("\u03b9\u03b5\u03c3\u03c4"))
                    break a;
            }
            a.cursor = a.a - n;
            a.d = a.cursor;
        ...
        a: {
            n = a.a - a.cursor;
            a.d = a.cursor;
            if (0 != a.h(Aa) && ((a.c = a.cursor), !a.b("\u03bc\u03b1")))
                break a;
            a.cursor = a.a - n;
